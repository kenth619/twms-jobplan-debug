    ...
    <div>
        ...
        <div v-else class="space-y-5">
            ...
            <div
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <div v-if="selectedJobPlans.length > 0" class="flex space-x-2">
                            ...
                            <!-- Bulk Delete Button (removed for now, can be added back later)
                ...
                <!--    Implemented a DataTable for listing all Job Plans with Striped row styling enabled via stripedRows for improved readability
                        Action buttons for viewing, editing, and deleting individual job plans.-->
                    ...
                    <Column header="Actions" style="width: 140px">
                        <template #body="{ data }">
                            <div class="flex space-x-1">
                                ...
                                <!-- Delete Button (removed for now, can be added back later)
                ...
                <div v-if="hasPagedData && totalPages > 1" class="flex justify-between items-center mt-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <Paginator :first="(currentPage - 1) * pageSize" :rows="pageSize" :total-records="totalCount"
                            @page="onPageChange" :rows-per-page-options="[5, 10, 20, 50]"
...
const debouncedSearch = useDebounceFn(async () => {
    if (searchTerm.value.trim()) {
        ...
        // Fetch all data if search term is cleared
        await fetchJobPlans()
    }
}, 300)
...
const clearSearch = async () => {
    ...
    selectedAssetClass.value = null // Reset asset class filter
    selectedStatus.value = null // Reset status filter
    await goToPage(1) // Reset pagination to the first page
    await fetchJobPlans() // Fetch all data to reload the table
}
