<!--    Created the Add Job Plan form interface.
        Integrated PrimeVue input components for:
        Job Plan Header fields (e.g., Plan Name, Description).
        Dynamic task management (description, duration).
        Form uses v-model binding and emits validation-ready form objects.
        Submit button triggers API call to backend using composable store logic. -->
