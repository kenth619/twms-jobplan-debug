...
<template>
    <div class="flex flex-grow h-full">
            ...
            <form @submit="onSubmit">
                <div class="space-y-2 mb-4">
                    ...
                    <Field v-slot="{ field, errorMessage }" name="username">
                        <InputText id="username" v-bind="field" fluid :invalid="!!errorMessage"
                ...
                <div class="space-y-2 mb-4">
                    ...
                    <Field v-slot="{ field, errorMessage }" name="password">
                        <Password id="password" v-bind="field" :invalid="!!errorMessage" fluid toggle-mask
                            :feedback="false" placeholder="Enter your password" autocomplete="current-password" />
                        <ErrorMessage :error-message="errorMessage" />
                    </Field>
                </div>
        ...
        <Dialog v-model:visible="showInactivityLogoutModal" modal header="Session Expired"
            class="w-[90vw] xl:max-w-[30rem]">
            <p>
                You have been automatically logged out due to inactivity.
            </p>
            <template #footer>
                <Button label="OK" severity="primary" @click="showInactivityLogoutModal = false" />
            </template>
        </Dialog>
    </div>
</template>
